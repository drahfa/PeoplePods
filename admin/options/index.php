...
<div class="panel">
	...
	<p class="input"><label for="siteName">What do you want to call your site?</label><input name="siteName" id="siteName" class="text required" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('siteName')); ?>" /></p>

	<p class="input"><label for="siteName">What is your <a href="http://peoplepods.net/">PeoplePods.net API Key</a></label><input name="peoplepods_api" id="peoplepods_api" class="text" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('peoplepods_api')); ?>" /></p>
	
	<p class="input"><label for="installDir">What is the path to your PeoplePods installation?</label><input name="installDir" id="installDir" class="text required" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('installDir')); ?>" />
	<span class="field_explain">Tells PeoplePods where to look for itself.</span></p>

	<p class="input"><label for="server">What is the URL for this PeoplePods website?</label><input name="server" id="server" class="text required" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('server')); ?>" />
	...
	<p class="input"><label for="siteRoot">What is the relative URL this PeoplePods app?</label><input name="siteRoot" id="siteRoot" class="text" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('siteRoot')); ?>" />
	...
	<p class="input"><label for="podRoot">What is the URL to the PeoplePods install?</label><input name="podRoot" id="podRoot" class="text required" type="text" value="<?php  echo htmlspecialchars($POD->libOptions('podRoot')); ?>" />
