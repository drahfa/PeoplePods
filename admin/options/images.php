...
<div class="panel">
	...
	<form method="post">
		<p><input type="checkbox" value="peopleImageResize" name="peopleImageResize" <?php  if ($POD->libOptions('peopleImageResize')) { ?>checked<?php }?> /> Resize profile images.
		<div class="more_info">
		...
		<div class="more_info">
			<input type="checkbox" value="peopleIconSquare" name="peopleIconSquare" <?php  if ($POD->libOptions('peopleIconSquare')) { ?>checked<?php }?> /> Crop to a square
		</div>
		</p>
	
		
		<h2>Document Images</h2>
		<p><input type="checkbox" value="documentImageResize" name="documentImageResize" <?php  if ($POD->libOptions('documentImageResize')) { ?>checked<?php }?> /> Resize document images.
		<div class="more_info">
			<P>Resize images to a maximum width of:
		...
		<div class="more_info">
			<input type="checkbox" value="documentIconSquare" name="documentIconSquare" <?php  if ($POD->libOptions('documentIconSquare')) { ?>checked<?php }?> /> Crop to a square
		</div>
		</p>
