...
<div class="column_8 structure_only" id="post_output">
	...
	<aside id="post_tools">
				...
				<ul class="post_actions">
					...
					<li><a href="#toggleFlag" data-flag="favorite" data-active="Un-fave" title="Mark as a favorite" data-inactive="Fave" data-content="<?= $doc->id; ?>" class="flag <?php  if ($doc->hasFlag('favorite',$POD->currentUser())) {?>active<?php  } ?>">Fave</a></li>				
					<li><a href="#toggleFlag" data-flag="watching" data-active="Tracking" title="Track new comments on the dashboard" data-inactive="Track" data-content="<?= $doc->id; ?>" class="flag <?php  if ($doc->hasFlag('watching',$POD->currentUser())) {?>active<?php  } ?>">Track</a></li>
