		...
		<section class="attributed_content content_body">
			...
			<ul class="content_options">
				...
				<li class="option_watching">
					<a href="#toggleFlag" data-flag="watching" data-content="<?= $doc->id; ?>" data-active="Stop Tracking" data-inactive="Start Tracking" title="Track new comments" class="<?php  if ($doc->hasFlag('watching',$POD->currentUser())){?>active<?php  } ?>">Stop Tracking</a>
				</li>
			</ul>
		</section>
