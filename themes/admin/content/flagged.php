<div class="doc_short">
	<div class="column_1">
		<div class="column_padding">
			<?php  if ($img = $content->files()->contains('file_name','img')) { ?>
				<a href="<?php  $content->write('permalink'); ?>"><img src="<?= $img->src(50,true); ?>" border="0" height="50" width="50" /></a>
			<?php  } else { ?>
	...
	<div class="column_2 last">
		<div class="column_padding">
			...
			<?php  } else { ?>
				<a href="<?php  $content->POD->podRoot(); ?>/admin/flags/index.php?contentId=<?php  $content->write('id'); ?>&flag=<?= $content->flag; ?>&type=user&direction=in">
