<div class="person_short">
	<div class="column_1">
		<div class="column_padding">
			<?php  if ($img = $user->files()->contains('file_name','img')) { ?>
				<a href="<?php  $user->write('permalink'); ?>"><img src="<?= $img->src(50,true); ?>" border="0" height="50" width="50" /></a>
			<?php  } else { ?>
	...
	<div class="column_2 last">
		<div class="column_padding">
			...
			<?php  } else { ?>
				<a href="<?php  $user->POD->podRoot(); ?>/admin/flags/index.php?userId=<?php  $user->write('id'); ?>&flag=<?= $user->flag; ?>&type=user&direction=in">
